...
const steps = [
  ...
  },
  {
    ...
    command: "git clone https://github.com/you/bebop",
    action: "Fork Repo",
  },
  {
          ...
          {steps.map((step, index) => (
            <div key={index} className="bg-dark-grey p-6 rounded-lg shadow-md flex flex-col">
              ...
              <div className="space-y-3">
                <div className="bg-black/30 p-2 rounded-md font-mono text-sm">{step.command}</div>
                <Button variant="secondary" className="w-full bg-white/10 hover:bg-white/20 border-0">
                  {step.action}
                </Button>
              </div>
            </div>
